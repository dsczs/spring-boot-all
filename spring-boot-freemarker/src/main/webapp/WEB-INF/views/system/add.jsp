...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h2 class="page-header">Add News<a class="pull-right btn btn-primary"
                                               href="/system/admin/news/list">Back</a></h2>
            <form class="form-horizontal" action="/system/admin/news/save" method="post" id="news-form">
                ...
                <div class="form-group form-group-sm">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" type="text" id="summary" name="summary" placeholder="Summary"
                               maxlength="500">
                    </div>
                </div>
                ...
                <div class="form-group form-group-sm">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" style="height:300px;visibility:hidden;" id="content"
