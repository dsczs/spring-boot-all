...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h2 class="page-header">&nbsp;<a class="pull-right btn btn-primary" href="/system/admin/news/list">Back</a>
            </h2>
            ...
            <div class="row">
                <p class="blog-post-meta pull-right"><fmt:formatDate value="${info.createTime}"
                                                                     pattern="yyyy-MM-dd HH:mm:ss"/> by <a
                        href="#">${info.author}</a></p>
                ${info.content}
            </div>
        </div>
    </div>
