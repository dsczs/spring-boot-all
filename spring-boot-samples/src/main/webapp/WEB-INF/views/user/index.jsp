    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                ...
                <p>
                    Write clean, testable code against the infrastructure components of your choice and accomplish any
                    task – without re-inventing the wheel.
                </p>
            </div>
            <div class="col-md-4">
                <h2>RUN ANYWHERE</h2>
                <p>
                    Keep it portable – Spring-based apps run anywhere the JVM does. Deploy standalone, in an app server,
                    on a PaaS or all of the above.
                </p>
            </div>
            <div class="col-md-4">
                <h2>REST ASSURED</h2>
                <p>
                    Code with confidence – Spring provides an open programming model that is comprehensive, cohesive,
