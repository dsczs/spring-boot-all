                    ...
                    <tr>
                        <td>
                            <a href="#" class="easyui-linkbutton" iconCls="grid-add" plain="true"
                               onclick="Index.addTaskInfo()">Add</a>
                            ...
                            <a href="#" class="easyui-linkbutton" iconCls="grid-edit" plain="true"
                               onclick="Index.updateTaskInfo()">Edit</a>
                            <div class="datagrid-btn-separator"
                                 style="vertical-align: middle; height: 15px;display:inline-block;float:none"></div>
                            <a href="#" class="easyui-linkbutton" iconCls="grid-del" plain="true"
                               onclick="Index.deleteTaskInfo()">Remove</a>
                        </td>
                        <td style="text-align:right">
                            <input type="text" class="easyui-textbox" id="hotelNameSearch"
                                   data-options="prompt:'Hotel Name'"/>
                            <a href="#" class="easyui-linkbutton" iconCls="icon-search" plain="true"
                               onclick="Index.searchHotelName()">Search</a>
                        </td>
                    </tr>
            ...
            <div id="taskinfoDialog" style="padding:10px 0px; display: none;">
                <form id="taskinfoForm" class="easyui-form" method="post" data-options="novalidate:true">
                    <table style="width: 300px;margin: 0 auto;">
                        <tr>
                            <td>Name</td>
                            <td><input class="easyui-textbox" name="name" style="width:100%"
                                       data-options="required:true"></td>
                        </tr>
                        <tr>
                            <td>State</td>
                            <td>
                                <input class="easyui-textbox" name="state" style="width:100%"
                        ...
                        <tr>
                            <td>Map</td>
                            <td>
                                <input class="easyui-textbox" name="map" style="width:100%"
                                       data-options="required:true">
                            </td>
                        </tr>
                        <tr>
                            <td>Country</td>
                            <td>
                                <input class="easyui-textbox" name="country" style="width:100%"
                                       data-options="required:true">
