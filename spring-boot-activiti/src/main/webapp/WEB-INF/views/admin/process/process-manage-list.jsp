            ...
            <tr>
                <td>
                    <a href="#" class="easyui-linkbutton" iconCls="grid-add" plain="true"
                       onclick="ProcessManage.addProcess()">新增</a>
                    ...
                    <a href="#" class="easyui-linkbutton" iconCls="grid-edit" plain="true"
                       onclick="ProcessManage.update()">修改</a>
                    <div class="datagrid-btn-separator"
                         style="vertical-align: middle; height: 15px;display:inline-block;float:none"></div>
                ...
                <td style="text-align:right">
                    ...
                    <a href="#" class="easyui-linkbutton" iconCls="icon-search" plain="true"
                       onclick="ProcessManage.search()">查询</a>
                </td>
            </tr>
        </table>
    </div>
    ...
    <div id="process-manage-dialog" style="padding:10px 0px;">
        <form id="process-manage-form" class="easyui-form" method="post" data-options="novalidate:true">
            <table style="width: 350px;margin: 0 auto;">
                <tr>
                    <td>任务名称</td>
                    <td><input class="easyui-textbox" name="processName" style="width:100%"
                               data-options="required:true"></td>
                    <td width="50"></td>
                </tr>
                <tr>
                    <td>任务文件</td>
                    <td><input class="easyui-textbox" name="processFile" style="width:100%"
                               data-options="required:true"></td>
