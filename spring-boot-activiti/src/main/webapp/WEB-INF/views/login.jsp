        ...
        <div data-options="region:'center',border:false" style="padding:5px;background:#fff;border:1px solid #ccc;">
            <form id="loginForm" method="post" action="/login">
                <div style="padding:5px 0;">
                    <input class="easyui-textbox" name="username" style="width:260px;"
                           data-options="label:'账号:',required:true">
                </div>
                <div style="padding:5px 0;">
                    <input class="easyui-passwordbox" name="password" style="width:260px;"
                           data-options="label:'密码:',required:true">
                </div>
                <div style="padding:5px 0;">
                    <input class="easyui-textbox" name="captcha" style="width:150px;"
